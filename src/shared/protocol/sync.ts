...
const SYNC_WORDS = [
  'ALPHA', 'ARROW', 'ATLAS', 'BIRCH', 'BLADE', 'BLAZE', 'BLOOM', 'BRAVE',
  'BRISK', 'CEDAR', 'CHALK', 'CLIFF', 'CORAL', 'CRANE', 'CREST', 'CROWN',
  'DELTA', 'DRIFT', 'EAGLE', 'EMBER', 'FABLE', 'FLAME', 'FLINT', 'FORGE',
  'FROST', 'GLEAM', 'GLOBE', 'GRAIN', 'GROVE', 'HAVEN', 'HAZEL', 'HERON',
  'IVORY', 'JEWEL', 'LANCE', 'LARCH', 'LIGHT', 'LINEN', 'MAPLE', 'MARSH',
  'NORTH', 'OCEAN', 'OLIVE', 'ONYX',  'ORBIT', 'PEARL', 'PETAL', 'PIXEL',
  'PLUME', 'PRISM', 'QUAIL', 'QUEST', 'RAVEN', 'RIDGE', 'RIVER', 'ROWAN',
  'SABLE', 'SHADE', 'SLATE', 'SOLAR', 'SPARK', 'SPIRE', 'STEEL', 'STONE',
  'STORM', 'SWIFT', 'THORN', 'TIGER', 'TORCH', 'TRAIL', 'VAPOR', 'VIVID',
  'WHALE', 'WREN',  'WOLF',  'ZENITH',
];
